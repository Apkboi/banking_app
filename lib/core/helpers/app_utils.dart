      ...
      builder: (context) =>
          BackdropFilter(
            ...
            child: AlertDialog(
                ...
                content: DangerDialog(title: title,
                    message: message,
...
class CustomSnackBar {
  ...
  CustomSnackBar.show(this.context, {
    required String message,
    Function? action,
  ...
  CustomSnackBar.showError(this.context, {
    required String message,
    Function? action,
    String? actionMessage,
    Color? backgroundColor,
